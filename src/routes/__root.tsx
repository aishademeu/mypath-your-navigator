    ...
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <p className="mt-2 text-sm text-muted-foreground">
          This path doesn't exist yet. Let's get you back on yours.
        </p>
        <div className="mt-6">
    ...
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <div className="mt-6 flex justify-center gap-2">
          ...
          <a href="/" className="rounded-full border border-input bg-background px-5 py-2.5 text-sm font-medium">Home</a>
        </div>
      </div>
    </div>
  );
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "MyPath helps ambitious students 13–18 discover themselves, find meaningful opportunities, and build a future they truly believe in." },
      { property: "og:title", content: "MyPath — Find your path. Build your future." },
      { property: "og:description", content: "The premium personal growth platform for ambitious students." },
